# kafka-lambda-oauth-python-sam / iam_auth
# Python AWS Lambda consumer for Amazon MSK via a self-managed Kafka event source with IAM_AUTH
...
- `kafka_event_consumer_function/` - the Python consumer (`app.py`, writes to DynamoDB).
